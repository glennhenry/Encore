...
import encore.security.validation.FailStrategy
import encore.security.validation.ValidationResult
import encore.security.validation.ValidationScheme
...
class TestValidationScheme {
    ...
    fun `test validation pass`() {
        val result = ValidationScheme("encore/exampleexample") { "HelloWorld Ktor" }
    ...
    fun `test validation fail at non-last stage with default strategy`() {
        val result = ValidationScheme("encore/exampleexample") { "Hello Ktor" }
            .require("Contains space") { contains(" ") }
